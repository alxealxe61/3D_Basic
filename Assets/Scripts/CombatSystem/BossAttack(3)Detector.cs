...
{
    public class BossAttack3Detector : MonoBehaviour, IHitDetector
    {
        public ICombatAgent Owner { get; private set; }
        
        [field: SerializeField]  public LayerMask DetectionLayer { get; private set; }
        
        [field: SerializeField]  private Collider leftCollider { get; set; }
        [field: SerializeField]  private Collider rightCollider { get; set; }
